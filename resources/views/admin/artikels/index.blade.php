                            ...
                            <div class="modal-body">
                                <form action="{{ route('artikels.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="paragrap2_day1"
                                            name="paragrap2_day1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="paragrap2_day2"
                                            name="paragrap2_day2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="paragrap2_day3"
                                            name="paragrap2_day3">
                                    ...
                                    <table id="add-row" class="table display table-striped table-hover">
                                        ...
                                        <tbody>
                                            @foreach ($artikels as $artikel)
                                                ...
                                                <div class="modal fade" id="exampleModal{{ $artikel->id }}"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form
                                                                    action="{{ route('artikels.update', $artikel->id) }}"
                                                                    ...
                                                                    <!-- Paragraphs for Day 1 -->
                                                                    <div class="form-group">
                                                                        <label for="paragrap1_day1">Paragraf 1 Hari
                                                                            1:</label>
                                                                        <input type="text" class="form-control"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="paragrap2_day1">Paragraf 2 Hari
                                                                            1:</label>
                                                                        <input type="text" class="form-control"
                                                                    ...
                                                                    <!-- Paragraphs for Day 2 -->
                                                                    <div class="form-group">
                                                                        <label for="paragrap1_day2">Paragraf 1 Hari
                                                                            2:</label>
                                                                        <input type="text" class="form-control"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="paragrap2_day2">Paragraf 2 Hari
                                                                            2:</label>
                                                                        <input type="text" class="form-control"
                                                                    ...
                                                                    <!-- Paragraphs for Day 3 -->
                                                                    <div class="form-group">
                                                                        <label for="paragrap1_day3">Paragraf 1 Hari
                                                                            3:</label>
                                                                        <input type="text" class="form-control"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="paragrap2_day3">Paragraf 2 Hari
                                                                            3:</label>
                                                                        <input type="text" class="form-control"
                                                                    ...
                                                                    <!-- Paragraphs for Day 4 -->
                                                                    <div class="form-group">
                                                                        <label for="paragrap1_day4">Paragraf 1 Hari
                                                                            4:</label>
                                                                        <input type="text" class="form-control"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="paragrap2_day4">Paragraf 2 Hari
                                                                            4:</label>
                                                                        <input type="text" class="form-control"
