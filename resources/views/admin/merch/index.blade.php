                                    ...
                                    <tbody>
                                        @foreach ($merch as $merch)
                                            <tr>
                                                ...
                                                <td>{{ $merch->price }}</td>
                                                <td>
                                                    <img src="{{ asset($merch->image) }}" alt="{{ $merch->name }}"
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <button type="button" class="btn btn-link btn-warning btn-lg"
                                                            ...
                                                            data-bs-target="#exampleModal{{ $merch->id }}">
                                                        ...
                                                        <form class="form-button-action"
                                                            action="{{ route('merch.destroy', $merch->id) }}"
                                            ...
                                            <div class="modal fade" id="exampleModal{{ $merch->id }}" tabindex="-1"
                                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Merch
                                                            </h1>
                                                            <button type="button" class="btn-close"
                                                                data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form action="{{ route('merch.update', $merch->id) }}"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="name" name="name"
                                                                        value="{{ $merch->name }}" required>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="description">Description:</label>
                                                                    <textarea class="form-control" id="description" name="description">{{ $merch->description }}</textarea>
                                                                </div>
